...
namespace ModLibsGeneral.Libraries.NPCs {
	...
	/// </summary>
	public partial class NPCCommonGroupsLibraries {
		/// <summary></summary>
		...
		static NPCCommonGroupsLibraries() {
			...
			NPCCommonGroupsLibraries.VanillaBloodMoonTypes = new ReadOnlySet<int>( bloodMoon );
			NPCCommonGroupsLibraries.VanillaGoblinArmyTypes = new ReadOnlySet<int>( goblins );
			NPCCommonGroupsLibraries.VanillaFrostLegionTypes = new ReadOnlySet<int>( frostLegion );
			NPCCommonGroupsLibraries.VanillaPirateTypes = new ReadOnlySet<int>( pirates );
			NPCCommonGroupsLibraries.VanillaMartianTypes = new ReadOnlySet<int>( martians );
			NPCCommonGroupsLibraries.VanillaSolarEclipseTypes = new ReadOnlySet<int>( solarEclipse );
			NPCCommonGroupsLibraries.VanillaPumpkingMoonTypes = new ReadOnlySet<int>( pumpkinMoon );
			NPCCommonGroupsLibraries.VanillaFrostMoonTypes = new ReadOnlySet<int>( frostMoon );
			NPCCommonGroupsLibraries.VanillaOldOnesArmyTypes = new ReadOnlySet<int>( oldOnesArmy );
			NPCCommonGroupsLibraries.VanillaSolarPillarTypes = new ReadOnlySet<int>( solarPillar );
			NPCCommonGroupsLibraries.VanillaNebulaPillarTypes = new ReadOnlySet<int>( nebulaPillar );
			NPCCommonGroupsLibraries.VanillaVortexPillarTypes = new ReadOnlySet<int>( vortexPillar );
			NPCCommonGroupsLibraries.VanillaStardustPillarTypes = new ReadOnlySet<int>( stardustPillar );
		}
	}
}
